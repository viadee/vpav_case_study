...
import de.viadee.bpm.camundaStaticValidator.config.model.ElementConvention;
import de.viadee.bpm.camundaStaticValidator.config.model.ElementFieldTypes;
import de.viadee.bpm.camundaStaticValidator.config.model.Rule;
import de.viadee.bpm.camundaStaticValidator.processing.ProcessVariableReader;
import de.viadee.bpm.camundaStaticValidator.processing.checker.ElementChecker;
import de.viadee.bpm.camundaStaticValidator.processing.checker.ProcessVariablesNameConventionChecker;
...
public class ProcessVariablesNameConventionCheckerTest {
  ...
  public static void setup() throws MalformedURLException {
    ...
    beanMapping.put("myBean", "de.viadee.bpm.camundaStaticValidator.delegates.TestDelegate");
