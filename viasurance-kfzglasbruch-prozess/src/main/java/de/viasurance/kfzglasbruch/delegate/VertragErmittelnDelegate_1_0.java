...
public class VertragErmittelnDelegate_1_0 implements JavaDelegate {

    private final static Logger LOGGER = Logger.getLogger(VertragErmittelnDelegate_1_0.class.getName());
    ...
    public void execute(final DelegateExecution execution) throws Exception {
        ...
        execution.setVariable("ext_schaden", "json");
    }
